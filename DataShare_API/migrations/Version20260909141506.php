 ...
 */
final class Version20260909141506 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create the user, file, tag and file_tag tables.';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE file (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, expiration_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, password VARCHAR(255) DEFAULT NULL, upload_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, size BIGINT NOT NULL, storage_key VARCHAR(255) NOT NULL, owner_id INT DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('ALTER TABLE file ADD CONSTRAINT FK_8C9F36107E3C61F9 FOREIGN KEY (owner_id) REFERENCES "user" (id) NOT DEFERRABLE');
